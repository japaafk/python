...
print(f'o resto da divisão deles é {numero1%numero2}')
print(f'a potência desses números é {numero1**numero2}')
print(f'a divisão exata deles é {numero1//numero2}')

# um número é par quando dividimos por 2 e o resto for zero
# se x % 2 == 0 é par